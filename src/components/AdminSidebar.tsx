...
export default function AdminSidebar() {
  ...
  return (
    <aside className="hidden md:flex flex-col w-64 bg-pcg-navy min-h-screen fixed left-0 top-0">
      {/* Logo */}
      ...
      <div className="px-3 py-4 border-t border-white/10">
        <button
          ...
          className="w-full flex items-center gap-3 px-3 py-2.5 text-blue-300 hover:text-white hover:bg-white/10 rounded-xl transition-colors"
        >
          <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
